  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO
        ...
        description={`Get your AI Visibility Score in ${city.name}, ${city.state}. Join over ${city.contractors.toLocaleString()} ${getTerm('tradespeople')} optimizing their online presence. ${formatPrice(49)} to start.`}
      />
      <Header />
