...
const pricingPlans = [
  {
    id: 'solo',
    name: 'Solo',
    headline: '🎙️ AI Voice + AI Visibility',
    subheadline: 'One-person trade business. One price. Two products.',
    price: 69,
    period: '/month',
    duration: 'monthly',
    popular: false,
    ...
    trustSignal: '✓ 14-day free trial  ✓ No credit card  ✓ Cancel anytime',
    targetPersona: 'Independent tradespeople: plumbers, electricians, builders, roofers',
    minutes: '300',
    features: [
      '📞 300 minutes AI voice answering',
      '🤖 24/7 call coverage — weekends, bank holidays',
      '📅 Calendar booking (Google, Outlook)',
      '🛡️ Spam filtering',
      '💬 WhatsApp call summaries',
      '🚨 Emergency routing to your mobile',
  ...
  },
  {
    ...
    subheadline: 'Growing team (2–5 staff). More minutes. More visibility.',
    price: 129,
    period: '/month',
    duration: 'monthly',
    popular: true,
    ...
    cta: 'Start Free Trial →',
    trustSignal: '✓ 14-day free trial  ✓ No credit card  ✓ Cancel anytime',
    targetPersona: 'Small firms with multiple vans or staff',
    minutes: '600',
    features: [
      '📞 600 minutes AI voice answering',
  ...
  },
  {
    ...
    name: 'Professional',
    headline: '💼 Full Power',
    subheadline: 'Established business. Maximum visibility. Maximum calls.',
    price: 219,
    period: '/month',
    duration: 'monthly',
    popular: false,
    ...
    cta: 'Start Free Trial →',
    trustSignal: '✓ 14-day free trial  ✓ No credit card  ✓ Cancel anytime',
    targetPersona: 'Established trades businesses with reputation to protect',
    minutes: '1200',
    features: [
      '📞 1,200 minutes AI voice answering',
  ...
  },
  {
    ...
    subheadline: 'Franchise or multi-branch operation. Custom setup. White-glove service.',
    price: 499,
    period: '/month',
    duration: 'monthly',
    popular: false,
    featured: false,
    cta: 'Contact Sales',
    trustSignal: 'Custom implementation. Dedicated success manager.',
    targetPersona: 'Multi-location franchises, large trade firms',
    minutes: '3000',
    features: [
      '📞 3,000 minutes AI voice answering',
      '✨ Everything in Professional, plus:',
      '📁 Unlimited directory listings',
      '🏢 Multi-location management',
      '⚙️ Custom AI voice training',
      '🔗 API access',
      '👔 White-glove setup',
      '📋 SLA guarantee'
    ]
