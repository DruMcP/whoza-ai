...
const nextConfig = {
  ...
  async rewrites() {
    ...
    return [
      ...
      {
        source: '/trade/plumber',
        destination: '/for-plumbers',
        permanent: true,
      },
      {
        source: '/trade/electrician',
        destination: '/for-electricians',
        permanent: true,
      },
      {
        source: '/trade/gas-engineer',
        destination: '/for-gas-engineers',
        permanent: true,
      },
      {
      ...
      {
        source: '/trade/locksmith',
        destination: '/for-locksmiths',
        permanent: true,
      },
      {
        source: '/trade/heating-engineer',
        destination: '/for-heating-engineers',
        permanent: true,
      },
      {
        source: '/trade/drainage',
        destination: '/for-drainage',
        permanent: true,
      },
      {
        source: '/trade/carpenter',
        destination: '/for-carpenters',
        permanent: true,
      },
      {
        source: '/trade/joiner',
      ...
      {
        source: '/trade/plasterer',
        destination: '/for-plasterers',
        permanent: true,
      },
      {
        source: '/trade/tiler',
        destination: '/for-tilers',
        permanent: true,
      },
      {
        source: '/trade/handyman',
        destination: '/for-handymen',
        permanent: true,
      },
      {
        source: '/trade/landscaper',
        destination: '/for-landscapers',
        permanent: true,
      },
      {
