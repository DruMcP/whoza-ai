...
export const metadata: Metadata = {
  ...
  description: "Stop losing heating engineers jobs to missed calls in Glasgow. Katie answers 24/7, captures boiler breakdowns, no heating & gas emergencies, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
  alternates: {
...
const faqs = [
  {
    "question": "How much does AI call answering cost for heating engineers in Glasgow?",
    "answer": "whoza.ai starts at £59/month for the Starter plan. That's less than one heating engineer job in Glasgow. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most heating engineers recover the cost within 48 hours by capturing just one missed job."
  },
  {
    "question": "Can Katie handle emergency calls for heating engineers in Glasgow?",
  ...
  {
    "question": "What information does Katie collect from heating engineers customers in Glasgow?",
  ...
  {
    "question": "How quickly can I get set up as a heating engineer in Glasgow?",
    "answer": "Most heating engineers in Glasgow are live and capturing calls within 30 minutes. Sign up, connect your number via call forwarding, set your greeting and business details, and Katie starts answering immediately. No hardware, no IT team, no technical knowledge required."
  },
  {
    "question": "What makes whoza.ai different for heating engineers in Glasgow?",
    "answer": "Unlike generic call answering services, Katie is trained specifically for heating engineers. She understands boiler breakdowns, servicing, installations & Gas Safety certificates — and with 5,500+ trade businesses competing in Glasgow, capturing every call gives you a real competitive edge."
  }
]

export const revalidate = 3600

export default function ForHeatingEngineerGlasgowPage() {
  return (
    <>
      <Header />
      <BreadcrumbSchema items={[
        ...
        { name: "Glasgow", item: "https://whoza.ai/for-heating-engineers-glasgow" },
      ]} />
      <FAQPageSchema faqs={faqs} />

      <script
        id="heating-engineers-glasgow-schema"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "LocalBusiness",
                "name": "whoza.ai - AI Call Answering for Heating Engineers in Glasgow",
                "address": {
                  "@type": "PostalAddress",
              ...
              },
              {
                ...
                "itemListElement": [
                  ...
                  { "@type": "ListItem", "position": 3, "name": "Glasgow", "item": "https://whoza.ai/for-heating-engineers-glasgow" }
                ]
              }
            ]
          })
      ...
      <main id="main-content" role="main" className="pb-24 lg:pb-0 bg-[var(--navy-900)] text-white">
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">Glasgow — Heating Engineer Enquiry</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-orange-500/10 rounded-lg p-3 border-orange-500/20 border">
                      <p className="text-sm text-white/90">"I need a heating engineer urgently in Glasgow!"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Glasgow Heating Engineers Market
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                The numbers that matter for heating engineers in Glasgow.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                { icon: Users, label: "Trade Businesses", value: "5,500+", color: "text-orange-400" },
                { icon: Home, label: "Households", value: "310K", color: "text-orange-400" },
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                The Real Cost of Missed Calls for Heating Engineers in Glasgow
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 leading-relaxed">
                      A customer calls about an urgent issue at 8pm while you're having dinner. They leave a voicemail, then call the next heating engineer on Google. You lose a £290+ job.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 text-center">
              <p className="text-emerald-200 font-medium text-lg">
                The average Glasgow heating engineer misses multiple calls per day = 
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                How Katie Works for Heating Engineers in Glasgow
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Questions Heating Engineers in Glasgow Ask
              </h2>
              <p className="text-white/60">
                Everything you need to know about AI call answering for heating engineers in Glasgow.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Stop Losing Heating Engineer Jobs in Glasgow Today
            </h2>
