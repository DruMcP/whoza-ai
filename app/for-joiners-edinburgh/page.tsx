...
export const metadata: Metadata = {
  ...
  description: "Stop losing joiner jobs to missed calls in Edinburgh. Katie answers 24/7, captures bespoke furniture and fitting enquiries via WhatsApp. Plans from £59.",
  alternates: {
