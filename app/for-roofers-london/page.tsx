...
import { ArrowRight, Phone, Warehouse, Shield, Clock, PoundSterling, CheckCircle2, Star, AlertTriangle, TrendingUp, Users, Home } from "lucide-react"
import Link from "next/link"

export const metadata: Metadata = {
  title: "AI Call Answering for Roofers in London | whoza.ai",
  description: "Stop losing roofer jobs to missed calls in London. Katie answers 24/7, captures storm damage and repair enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
...
export default function ForRooferLondonPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Roofer" tradePlural="Roofers" city="London" region="Greater London" pageUrl="https://whoza.ai/for-roofers-london" />
        {/* ─── HERO ─── */}
