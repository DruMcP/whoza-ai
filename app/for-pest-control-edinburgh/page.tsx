...
export const metadata: Metadata = {
  ...
  description: "Stop losing pest control jobs to missed calls in Edinburgh. Katie answers 24/7, captures infestation and emergency enquiries via WhatsApp. Plans from £59.",
  alternates: {
...
export default function ForPestControlEdinburghPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Pest Control Technician" tradePlural="Pest Control Services" city="Edinburgh" region="City of Edinburgh" pageUrl="https://whoza.ai/for-pest-control-edinburgh" />
