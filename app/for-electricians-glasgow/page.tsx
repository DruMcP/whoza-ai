...
const faqs = [
  ...
  {
    "question": "How quickly can I get set up as an electrician in Glasgow?",
      ...
      <CityTradeSchema trade="Electrician" tradePlural="Electricians" city="Glasgow" region="Greater Glasgow" pageUrl="https://whoza.ai/for-electricians-glasgow" />
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                What Electricians in Glasgow Face Daily
              </h2>
            </div>
            <div className="space-y-6 text-white/70 leading-relaxed">
              <p>
        ...
        <section className="py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <TradeCityLinks trade="for-electricians" current="glasgow" />
            <div className="mt-6">
