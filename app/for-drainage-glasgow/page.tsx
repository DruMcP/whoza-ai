...
export default function ForDrainageEngineerGlasgowPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Drainage Specialist" tradePlural="Drainage Specialists" city="Glasgow" region="Greater Glasgow" pageUrl="https://whoza.ai/for-drainage-glasgow" />
