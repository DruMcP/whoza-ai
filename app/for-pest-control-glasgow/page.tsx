...
export const metadata: Metadata = {
  ...
  description: "Stop losing pest control jobs to missed calls in Glasgow. Katie answers 24/7, captures infestation and emergency enquiries via WhatsApp. Plans from £59.",
  alternates: {
...
export default function ForPestControlGlasgowPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Pest Control Technician" tradePlural="Pest Control Services" city="Glasgow" region="Greater Glasgow" pageUrl="https://whoza.ai/for-pest-control-glasgow" />
