...
export const metadata: Metadata = {
  ...
  description: "Stop losing joiner jobs to missed calls in Glasgow. Katie answers 24/7, captures bespoke furniture and fitting enquiries via WhatsApp. Plans from £59.",
  alternates: {
...
export default function ForJoinerGlasgowPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Joiner" tradePlural="Joiners" city="Glasgow" region="Greater Glasgow" pageUrl="https://whoza.ai/for-joiners-glasgow" />
