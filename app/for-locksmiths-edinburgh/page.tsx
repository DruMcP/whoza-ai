...
import { ArrowRight, Phone, Key, Shield, Clock, PoundSterling, CheckCircle2, Star, AlertTriangle, TrendingUp, Users, Home } from "lucide-react"
import Link from "next/link"

export const metadata: Metadata = {
  title: "AI Call Answering for Locksmiths in Edinburgh | whoza.ai",
  description: "Stop losing locksmith jobs to missed calls in Edinburgh. Katie answers 24/7, captures emergency lockout and key enquiries via WhatsApp. Plans from £59.",
  alternates: {
    canonical: "https://whoza.ai/for-locksmiths-edinburgh",
  },
  openGraph: {
    type: "website",
    locale: "en_GB",
    url: "https://whoza.ai/for-locksmiths-edinburgh",
    siteName: "Whoza.ai",
    title: "AI Call Answering for Locksmiths in Edinburgh | whoza.ai",
    description: "Stop losing locksmith jobs to missed calls in Edinburgh. Katie answers 24/7, captures emergency lockout and key enquiries via WhatsApp. Plans from £59.",
    images: [{ url: "https://whoza.ai/og-image.webp", width: 1200, height: 630, alt: "whoza.ai — AI Call Answering for Locksmiths in Edinburgh" }],
  },
  twitter: {
...
const faqs = [
  {
    "question": "How much does AI call answering cost for locksmiths in Edinburgh?",
    "answer": "whoza.ai starts at £59/month for the Starter plan. That's less than one locksmith job in Edinburgh. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most locksmiths recover the cost within 48 hours by capturing just one missed job."
  },
  {
    "question": "Can Katie handle emergency calls for locksmiths in Edinburgh?",
  ...
  {
    "question": "What information does Katie collect from locksmiths customers in Edinburgh?",
  ...
  {
    "question": "How quickly can I get set up as a locksmith in Edinburgh?",
    "answer": "Most locksmiths in Edinburgh are live and capturing calls within 30 minutes. Sign up, connect your number via call forwarding, set your greeting and business details, and Katie starts answering immediately. No hardware, no IT team, no technical knowledge required."
  },
  {
    "question": "What makes whoza.ai different for locksmiths in Edinburgh?",
    "answer": "Unlike generic call answering services, Katie is trained specifically for locksmiths. She understands lockouts, lock changes, security upgrades & emergency entry — and with 4,500+ trade businesses competing in Edinburgh, capturing every call gives you a real competitive edge."
  }
]

export const revalidate = 3600

export default function ForLocksmithEdinburghPage() {
  return (
    <>
      <Header />
      <BreadcrumbSchema items={[
        ...
        { name: "Edinburgh", item: "https://whoza.ai/for-locksmiths-edinburgh" },
      ]} />
      <FAQPageSchema faqs={faqs} />

      <script
        id="locksmiths-edinburgh-schema"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "LocalBusiness",
                "name": "whoza.ai - AI Call Answering for Locksmiths in Edinburgh",
                "address": {
                  "@type": "PostalAddress",
      ...
      <CityTradeSchema trade="Locksmith" tradePlural="Locksmiths" city="Edinburgh" region="City of Edinburgh" pageUrl="https://whoza.ai/for-locksmiths-edinburgh" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-balance mb-6">
                  Never Miss a{" "}
                  <span className="text-amber-400">Locksmith</span>{" "}
                ...
                <p className="text-xl text-white/70 leading-relaxed mb-8 max-w-xl">
                  ...
                  Katie ensures you capture every locksmiths enquiry — lockouts, lock changes, security upgrades & emergency entry.
                </p>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">Edinburgh — Locksmith Enquiry</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-amber-500/10 rounded-lg p-3 border-amber-500/20 border">
                      <p className="text-sm text-white/90">"I need a locksmith urgently in Edinburgh!"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Edinburgh Locksmiths Market
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                The numbers that matter for locksmiths in Edinburgh.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                { icon: Users, label: "Trade Businesses", value: "4,500+", color: "text-amber-400" },
                { icon: Home, label: "Households", value: "245K", color: "text-amber-400" },
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                The Real Cost of Missed Calls for Locksmiths in Edinburgh
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 leading-relaxed">
                      A customer calls about an urgent issue at 8pm while you're having dinner. They leave a voicemail, then call the next locksmith on Google. You lose a £315+ job.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 text-center">
              <p className="text-emerald-200 font-medium text-lg">
                The average Edinburgh locksmith misses multiple calls per day = 
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                How Katie Works for Locksmiths in Edinburgh
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
        ...
        <section className="py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">
              AI Call Answering for Locksmiths Across the UK
            </h2>
            <p className="text-white/60 mb-6">
              Katie answers calls for locksmiths in cities nationwide. Find your location:
            </p>
            ...
            <div className="mt-6">
              <Link href="/for-locksmiths" className="inline-flex items-center text-amber-400 hover:text-amber-300 text-sm font-medium transition-all">
                View all Locksmiths →
              </Link>
            </div>
          </div>
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Questions Locksmiths in Edinburgh Ask
              </h2>
              <p className="text-white/60">
                Everything you need to know about AI call answering for locksmiths in Edinburgh.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Stop Losing Locksmith Jobs in Edinburgh Today
            </h2>
