...
export const metadata: Metadata = {
  ...
  description: "Stop losing handymen jobs to missed calls in Glasgow. Katie answers 24/7, captures emergency enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
...
export default function ForHandymanGlasgowPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Handyman" tradePlural="Handymen" city="Glasgow" region="Greater Glasgow" pageUrl="https://whoza.ai/for-handymen-glasgow" />
