...
export const metadata: Metadata = {
  ...
  description: "Stop losing heating engineer jobs to missed calls in Edinburgh. Katie answers 24/7, captures boiler and heating enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
...
export default function ForHeatingEngineerEdinburghPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Heating Engineer" tradePlural="Heating Engineers" city="Edinburgh" region="City of Edinburgh" pageUrl="https://whoza.ai/for-heating-engineers-edinburgh" />
