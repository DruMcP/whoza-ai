...
export const metadata: Metadata = {
  title: "AI Call Answering for Heating Engineers in Edinburgh",
  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: "Heating Engineers in Edinburgh", item: "https://whoza.ai/for-heating-engineers-edinburgh" },
      ]} />
      <div>
      ...
      <CityTradeSchema trade="Heating Engineer" tradePlural="Heating Engineers" city="Edinburgh" region="City of Edinburgh" pageUrl="https://whoza.ai/for-heating-engineers-edinburgh" />
        ...
        <section className="py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <TradeCityLinks trade="for-heating-engineers" current="edinburgh" />
            <div className="mt-6">
