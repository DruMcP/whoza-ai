...
export const metadata: Metadata = {
  ...
  description: "Stop losing gas engineer jobs to missed calls in London. Katie answers 24/7, captures gas leak and safety enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
