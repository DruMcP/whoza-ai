...
import { ArrowRight, Phone, Flame, Shield, Clock, PoundSterling, CheckCircle2, Star, AlertTriangle, MapPin, TrendingUp, Users, Home } from "lucide-react"
import Link from "next/link"

export const metadata: Metadata = {
  title: "AI Call Answering for Gas Engineers in London | whoza.ai",
  description: "Stop losing gas-engineers jobs to missed calls in London. Katie answers 24/7, captures CP12 certificates, gas leaks, boiler breakdowns & carbon monoxide emergencies, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
  alternates: {
    canonical: "https://whoza.ai/for-gas-engineers-london",
  },
  openGraph: {
    type: "website",
    locale: "en_GB",
    url: "https://whoza.ai/for-gas-engineers-london",
    siteName: "Whoza.ai",
    title: "AI Call Answering for Gas Engineers in London | whoza.ai",
    description: "Stop losing gas-engineers jobs to missed calls in London. Katie answers 24/7, captures CP12 certificates, gas leaks, boiler breakdowns & carbon monoxide emergencies, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
    images: [{ url: "https://whoza.ai/og-image.webp", width: 1200, height: 630, alt: "whoza.ai — AI Call Answering for Gas Engineers in London" }],
  },
  twitter: {
...
const faqs = [
  {
    "question": "How much does AI call answering cost for gas-engineers in London?",
    "answer": "whoza.ai starts at £59/month for the Starter plan. That's less than one gas engineer job in London. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most gas-engineers recover the cost within 48 hours by capturing just one missed job."
  },
  {
    "question": "Can Katie handle emergency calls for gas-engineers in London?",
  ...
  {
    "question": "What information does Katie collect from gas-engineers customers in London?",
  ...
  {
    "question": "How quickly can I get set up as a gas engineer in London?",
    "answer": "Most gas-engineers in London are live and capturing calls within 30 minutes. Sign up, connect your number via call forwarding, set your greeting and business details, and Katie starts answering immediately. No hardware, no IT team, no technical knowledge required."
  },
  {
    "question": "What makes whoza.ai different for gas-engineers in London?",
    "answer": "Unlike generic call answering services, Katie is trained specifically for gas-engineers. She understands CP12 certificates, gas leaks, boiler breakdowns & carbon monoxide emergencies — and with 32,000+ trade businesses competing in London, capturing every call gives you a real competitive edge."
  }
]

export const revalidate = 3600

export default function ForGasEngineerLondonPage() {
  return (
    <>
      <Header />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "FAQPage",
                "mainEntity": [{"@type":"Question","name":"How much does AI call answering cost for gas-engineers in London?","acceptedAnswer":{"@type":"Answer","text":"whoza.ai starts at £59/month for the Starter plan. That's less than one gas engineer job in London. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most gas-engineers recover the cost within 48 hours by capturing just one missed job."}},{"@type":"Question","name":"Can Katie handle emergency calls for gas-engineers in London?","acceptedAnswer":{"@type":"Answer","text":"Absolutely. Katie answers 24/7, including nights, weekends, and bank holidays. She identifies emergency calls and marks them as highest priority in your WhatsApp alert. Whether you're in London or anywhere in the UK, you'll see the emergency tag immediately and can respond within minutes."}},{"@type":"Question","name":"What information does Katie collect from gas-engineers customers in London?","acceptedAnswer":{"@type":"Answer","text":"Katie captures: full name, phone number, London postcode, property type, job description, urgency level, preferred appointment time, and how they found you. For emergencies, she also asks about immediate safety concerns and property damage extent."}},{"@type":"Question","name":"Does it work with my existing London business phone number?","acceptedAnswer":{"@type":"Answer","text":"Yes. You simply set up call forwarding from your existing London business number to your whoza.ai number. Your customers dial the same number they've always used — Katie answers when you can't. Setup takes under 10 minutes and works with both mobile and landline numbers."}},{"@type":"Question","name":"How quickly can I get set up as a gas engineer in London?","acceptedAnswer":{"@type":"Answer","text":"Most gas-engineers in London are live and capturing calls within 30 minutes. Sign up, connect your number via call forwarding, set your greeting and business details, and Katie starts answering immediately. No hardware, no IT team, no technical knowledge required."}},{"@type":"Question","name":"What makes whoza.ai different for gas-engineers in London?","acceptedAnswer":{"@type":"Answer","text":"Unlike generic call answering services, Katie is trained specifically for gas-engineers. She understands CP12 certificates, gas leaks, boiler breakdowns & carbon monoxide emergencies — and with 32,000+ trade businesses competing in London, capturing every call gives you a real competitive edge."}}]
              },
              {
                "@type": "LocalBusiness",
                "name": "whoza.ai - AI Call Answering for Gas Engineers in London",
                "address": {
                  "@type": "PostalAddress",
              ...
              {
                "@type": "Service",
                "serviceType": "AI Call Answering for Gas Engineers",
                "areaServed": {
                  "@type": "City",
                  "name": "London"
                }
              },
              {
                ...
                "itemListElement": [
                  ...
                  { "@type": "ListItem", "position": 2, "name": "For Gas Engineers", "item": "https://whoza.ai/for-gas-engineers" },
                  { "@type": "ListItem", "position": 3, "name": "London", "item": "https://whoza.ai/for-gas-engineers-london" }
                ]
              }
            ]
          })
      ...
      <main id="main-content" role="main" className="pb-24 lg:pb-0 bg-[var(--navy-900)] text-white">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 bg-red-500/10 text-red-400 px-4 py-2 rounded-full text-sm font-medium mb-6">
                  ...
                  Gas Engineers in London
                </div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-balance mb-6">
                  Never Miss a{" "}
                  <span className="text-red-400">Gas Engineer</span>{" "}
                  Job in London Again
                </h1>
                <p className="text-xl text-white/70 leading-relaxed mb-8 max-w-xl">
                  ...
                  Katie ensures you capture every gas-engineers enquiry — CP12 certificates, gas leaks, boiler breakdowns & carbon monoxide emergencies.
                </p>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">London — Gas Engineer Enquiry</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-red-500/10 rounded-lg p-3 border-red-500/20 border">
                      <p className="text-sm text-white/90">"I need a gas engineer urgently in London!"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                London Gas Engineers Market
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                The numbers that matter for gas-engineers in London.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                { icon: Users, label: "Trade Businesses", value: "32,000+", color: "text-red-400" },
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                The Real Cost of Missed Calls for Gas Engineers in London
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
            ...
            <div className="space-y-8">
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  <div className={`w-12 h-12 rounded-xl bg-red-500/10 border-red-500/20 border flex items-center justify-center flex-shrink-0`}>
                    <AlertTriangle className={`w-6 h-6 text-red-400`} />
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold mb-2">While You're on the Job</h3>
                    <p className="text-white/60 leading-relaxed">
                      A landlord calls about CP12 certificates for 8 properties before a new tenancy starts. You miss the call while on another job. By the time you call back, they've booked another Gas Safe engineer for the entire portfolio.
                    </p>
                  </div>
                </div>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 leading-relaxed">
                      A customer smells gas and calls you in a panic. You don't answer. They call the gas emergency line and then another Gas Safe engineer. You lose a £300 callout and the chance to build a long-term customer relationship.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 text-center">
              <p className="text-emerald-200 font-medium text-lg">
                The average London gas engineer misses multiple calls per day = 
                <strong> £48,000</strong> in lost revenue per year
              </p>
              <p className="text-emerald-200/70 text-sm mt-1">
                Based on £300 avg callout value with 35% conversion rate
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                How Katie Works for Gas Engineers in London
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                ...
                return (
                  <div key={idx} className="relative">
                    <div className="bg-white/5 border border-white/10 rounded-xl p-8 h-full">
                      ...
                      <div className={`w-12 h-12 rounded-xl bg-red-500/10 border-red-500/20 border flex items-center justify-center mb-4`}>
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                More Gas Engineers Locations
              </h2>
              <p className="text-white/60">
                Katie answers calls for gas-engineers across the UK.
              </p>
            </div>
            <div className="flex flex-wrap justify-center gap-3">
              {["London", "Manchester", "Birmingham", "Glasgow", "Bristol", "Liverpool", "Leeds", "Edinburgh"].map(city => (
                <Link
                  key={city}
                  href={`/for-gas-engineers-${city.toLowerCase().replace(/\s+/g, '-')}`}
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Questions Gas Engineers in London Ask
              </h2>
              <p className="text-white/60">
                Everything you need to know about AI call answering for gas-engineers in London.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Stop Losing Gas Engineer Jobs in London Today
            </h2>
