...
import { ArrowRight, Phone, LayoutGrid, Clock, PoundSterling, Shield, CheckCircle2, Star, AlertTriangle, Home, Calendar, HardHat, Briefcase } from "lucide-react"
        ...
        <section className="py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">
              AI Call Answering for Tilers in Your City
            </h2>
            <p className="text-white/60 mb-6">
              Katie answers calls for tilers across the UK. Find your location:
            </p>
