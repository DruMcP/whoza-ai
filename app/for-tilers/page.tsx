...
export const metadata: Metadata = {
  title: "Call Answering Service for Tilers | From £59",
  description: "24/7 call answering for UK tilers. Every bathroom, kitchen and floor tiling enquiry captured and sent to your WhatsApp in 3 seconds. Plans from £59.",
  alternates: {
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Katie introduces herself as your digital assistant with a natural, professional voice. Most callers appreciate the instant response over voicemail or a ringing phone. Most callers are satisfied with the AI experience — they just want their tiling project booked fast.",
  },
  {
...
<section className="trade-faq py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Questions Tilers Ask
              </h2>
              <p className="text-white/60">
                Everything you need to know about AI call answering for tiling businesses.
              </p>
            </div>
        ...
        <TradeCityLinks trade="for-tilers" />
