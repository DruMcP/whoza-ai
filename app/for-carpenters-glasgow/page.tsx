...
export const metadata: Metadata = {
  ...
  description: "Stop losing carpenter jobs to missed calls in Glasgow. Katie answers 24/7, captures bespoke furniture and fitting enquiries via WhatsApp. Plans from £59.",
  alternates: {
...
export default function ForCarpenterGlasgowPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Carpenter" tradePlural="Carpenters" city="Glasgow" region="Greater Glasgow" pageUrl="https://whoza.ai/for-carpenters-glasgow" />
