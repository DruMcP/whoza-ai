...
export const metadata: Metadata = {
  ...
  description: "Stop losing gas engineer jobs to missed calls in Edinburgh. Katie answers 24/7, captures gas leak and safety enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
...
export default function ForGasEngineerEdinburghPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Gas Engineer" tradePlural="Gas Engineers" city="Edinburgh" region="City of Edinburgh" pageUrl="https://whoza.ai/for-gas-engineers-edinburgh" />
