...
export const metadata: Metadata = {
  title: "Call Answering Service for Carpenters | From £59",
  description: "24/7 call answering for UK carpenters. Every bespoke furniture, kitchen fitting and renovation enquiry captured. WhatsApp alerts in 3 seconds. From £59.",
  alternates: {
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Katie introduces herself as your digital assistant with a natural, professional voice. Most callers appreciate the instant response over voicemail or a ringing phone. Most callers are satisfied with the AI experience — they just want their project started quickly.",
  },
  {
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  step: "03",
                  icon: Phone,
                  title: "Carpentry Project Brief in 3 Seconds",
...
<section className="trade-faq py-16 lg:py-24">
        ...
        <TradeCityLinks trade="for-carpenters" />
...
<section className="py-12 border-t border-white/10">
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid sm:grid-cols-3 gap-4">
      ...
      <div className="section-divider" />
        <RelatedTrades currentTrade="for-carpenters" />
        <Footer />
    </>
  )
}
