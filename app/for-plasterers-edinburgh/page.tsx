...
export const metadata: Metadata = {
  ...
  description: "Stop losing plasterer jobs to missed calls in Edinburgh. Katie answers 24/7, captures skimming and rendering enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
...
export default function ForPlastererEdinburghPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Plasterer" tradePlural="Plasterers" city="Edinburgh" region="City of Edinburgh" pageUrl="https://whoza.ai/for-plasterers-edinburgh" />
