...
export const metadata: Metadata = {
  ...
  description: "Stop losing builder jobs to missed calls in Glasgow. Katie answers 24/7, captures extension and renovation enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
