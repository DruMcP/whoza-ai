      ...
      <main id="main-content" role="main" className="pb-24 lg:pb-0">
        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="prose prose-lg prose-invert max-w-none">
            ...
            <p className="text-white/70 leading-relaxed mb-6">
              I used to think voicemail was fine. "They'll leave a message and I'll call back." They don't. <a href="/blog/how-much-do-missed-calls-cost-uk-trades" className="text-[var(--katie-blue)] hover:underline">69% of people who hit voicemail don't leave a message</a>. That's not my stat — that's from the Moneypenny Small Business Call Report, 2016. And it matches exactly what I saw.
            </p>
