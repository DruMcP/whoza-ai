...
export const metadata: Metadata = {
  ...
  description: "Everything UK tradespeople need to know about AI call answering. How it works, pricing, and choosing the right service. Complete 2026 guide. Plans from £59.",
  keywords: [
