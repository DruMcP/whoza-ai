...
import { ArrowRight, Star, PoundSterling, Clock, Shield, TrendingUp, MessageCircle, Check, X, ChevronDown , User, Calendar User } from "lucide-react"
          ...
          <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="bg-white/5 border border-white/10 rounded-xl p-8">
              <p className="text-white/70 leading-relaxed mb-4">
                If you're a <a href="/for-plumbers" className="text-emerald-400 hover:underline">plumber</a>, <a href="/for-electricians" className="text-emerald-400 hover:underline">electrician</a>, <a href="/for-roofers" className="text-emerald-400 hover:underline">roofer</a>, or any UK tradesperson, you've probably missed calls 
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "BlogPosting",
            "headline": "Best AI Phone Answering UK Trades 2026",
            "description": "Comparison of AI phone answering services for UK trades.",
