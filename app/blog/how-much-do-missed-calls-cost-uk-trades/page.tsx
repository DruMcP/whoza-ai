          ...
          <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8">
              ...
              <p className="text-white/70 leading-relaxed">
                That's <strong className="text-white">£25,480 per year</strong> in lost revenue for a single plumber 
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="space-y-3 text-white/70 text-sm">
                    <div className="flex justify-between"><span>Recovered plumber jobs</span><span>£25,480/yr</span></div>
                    <div className="flex justify-between"><span>Recovered electrician jobs</span><span>£19,968/yr</span></div>
                    <div className="flex justify-between"><span>Recovered roofer jobs</span><span>£33,150/yr</span></div>
