...
const faqs = [
    { question: "What percentage of small UK trade businesses fail to answer incoming calls?", answer: "The Moneypenny Small Business Call Report (2016) found that 33% of small UK trade businesses fail to answer incoming calls." },
    ...
    { question: "What percentage of missed calls result in a competitor being contacted?", answer: "24% of missed calls result in a competitor being contacted within 15 minutes. 69% of callers who reach voicemail leave no message (Moneypenny, Small Business Call Report, 2016)." },
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="space-y-6">
      <div className="bg-white/5 border border-white/10 rounded-xl p-6">
        ...
        <p className="text-white/70 leading-relaxed">The Moneypenny Small Business Call Report (2016) found that 33% of small UK trade businesses fail to answer incoming calls.</p>
      </div>
      <div className="bg-white/5 border border-white/10 rounded-xl p-6">
      ...
      <div className="bg-white/5 border border-white/10 rounded-xl p-6">
        ...
        <p className="text-white/70 leading-relaxed">24% of missed calls result in a competitor being contacted within 15 minutes. 69% of callers who reach voicemail leave no message (Moneypenny, Small Business Call Report, 2016).</p>
      </div>
      <div className="bg-white/5 border border-white/10 rounded-xl p-6">
