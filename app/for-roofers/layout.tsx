...
export const metadata: Metadata = {
  ...
  description: "Whoza.ai answers roofing calls 24/7. Qualifies tile repairs, leak emergencies \u0026 gutter jobs. Details to WhatsApp. 23 calls in 2 days = £8K recovered. Free trial.",
  alternates: {
