...
export const metadata: Metadata = {
  ...
  description: "Stop losing gas engineer jobs to missed calls in Glasgow. Katie answers 24/7, captures gas leak and safety enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
...
export default function ForGasEngineerGlasgowPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Gas Engineer" tradePlural="Gas Engineers" city="Glasgow" region="Greater Glasgow" pageUrl="https://whoza.ai/for-gas-engineers-glasgow" />
