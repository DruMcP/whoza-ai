...
export const metadata: Metadata = {
  ...
  description: "Stop losing carpenter jobs to missed calls in Edinburgh. Katie answers 24/7, captures bespoke furniture and fitting enquiries via WhatsApp. Plans from £59.",
  alternates: {
...
export default function ForCarpenterEdinburghPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Carpenter" tradePlural="Carpenters" city="Edinburgh" region="City of Edinburgh" pageUrl="https://whoza.ai/for-carpenters-edinburgh" />
