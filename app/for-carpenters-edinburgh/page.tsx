...
export const metadata: Metadata = {
  title: "AI Call Answering for Carpenters in Edinburgh | whoza.ai",
  description: "Stop losing carpenters jobs to missed calls in Edinburgh. Katie answers 24/7, captures broken doors, security issues & urgent repairs, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
  alternates: {
    canonical: "https://whoza.ai/for-carpenters-edinburgh",
  },
  openGraph: {
    type: "website",
    locale: "en_GB",
    url: "https://whoza.ai/for-carpenters-edinburgh",
    siteName: "Whoza.ai",
    title: "AI Call Answering for Carpenters in Edinburgh | whoza.ai",
    description: "Stop losing carpenters jobs to missed calls in Edinburgh. Katie answers 24/7, captures broken doors, security issues & urgent repairs, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
    images: [{ url: "https://whoza.ai/og-image.webp", width: 1200, height: 630, alt: "whoza.ai — AI Call Answering for Carpenters in Edinburgh" }],
  },
  twitter: {
...
const faqs = [
  {
    "question": "How much does AI call answering cost for carpenters in Edinburgh?",
    "answer": "whoza.ai starts at £59/month for the Starter plan. That's less than one carpenter job in Edinburgh. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most carpenters recover the cost within 48 hours by capturing just one missed job."
  },
  {
    "question": "Can Katie handle emergency calls for carpenters in Edinburgh?",
  ...
  {
    "question": "What information does Katie collect from carpenters customers in Edinburgh?",
  ...
  {
    "question": "How quickly can I get set up as a carpenter in Edinburgh?",
    "answer": "Most carpenters in Edinburgh are live and capturing calls within 30 minutes. Sign up, connect your number via call forwarding, set your greeting and business details, and Katie starts answering immediately. No hardware, no IT team, no technical knowledge required."
  },
  {
    "question": "What makes whoza.ai different for carpenters in Edinburgh?",
    "answer": "Unlike generic call answering services, Katie is trained specifically for carpenters. She understands bespoke joinery, kitchen fitting, door installation & woodwork repairs — and with 4,500+ trade businesses competing in Edinburgh, capturing every call gives you a real competitive edge."
  }
]

export const revalidate = 3600

export default function ForCarpenterEdinburghPage() {
  return (
    <>
      <Header />
      <BreadcrumbSchema items={[
        ...
        { name: "Edinburgh", item: "https://whoza.ai/for-carpenters-edinburgh" },
      ]} />
      <FAQPageSchema faqs={faqs} />

      <script
        id="carpenters-edinburgh-schema"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "LocalBusiness",
                "name": "whoza.ai - AI Call Answering for Carpenters in Edinburgh",
                "address": {
                  "@type": "PostalAddress",
              ...
              },
              {
                ...
                "itemListElement": [
                  ...
                  { "@type": "ListItem", "position": 2, "name": "For Carpenters", "item": "https://whoza.ai/for-carpenters" },
                  { "@type": "ListItem", "position": 3, "name": "Edinburgh", "item": "https://whoza.ai/for-carpenters-edinburgh" }
                ]
              }
            ]
          })
      ...
      <main id="main-content" role="main" className="pb-24 lg:pb-0 bg-[var(--navy-900)] text-white">
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">Edinburgh — Carpenter Enquiry</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-amber-500/10 rounded-lg p-3 border-amber-500/20 border">
                      <p className="text-sm text-white/90">"I need a carpenter urgently in Edinburgh!"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Edinburgh Carpenters Market
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                The numbers that matter for carpenters in Edinburgh.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                The Real Cost of Missed Calls for Carpenters in Edinburgh
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 leading-relaxed">
                      A customer calls about an urgent issue at 8pm while you're having dinner. They leave a voicemail, then call the next carpenter on Google. You lose a £315+ job.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 text-center">
              <p className="text-emerald-200 font-medium text-lg">
                The average Edinburgh carpenter misses multiple calls per day = 
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                How Katie Works for Carpenters in Edinburgh
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Questions Carpenters in Edinburgh Ask
              </h2>
              <p className="text-white/60">
                Everything you need to know about AI call answering for carpenters in Edinburgh.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Stop Losing Carpenter Jobs in Edinburgh Today
            </h2>
