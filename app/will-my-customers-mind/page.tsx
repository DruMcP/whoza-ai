...
export const metadata: Metadata = {
  ...
  description: "The honest answer: some callers can tell it's AI. But almost nobody hangs up — because the alternative is your voicemail. Here's what actually happens.",
  alternates: {
