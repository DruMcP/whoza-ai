...
export const metadata: Metadata = {
  ...
  title: "Whoza.ai vs ARROW — AI Call Answering Comparison",
    ...
    <div className="min-h-screen bg-[var(--navy-900)] text-white">
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Whoza vs ARROW", item: "https://whoza.ai/whoza-vs-arrow" },
        ]}
      />

      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <h1 className="text-3xl sm:text-4xl font-bold mb-6">
          Whoza.ai vs <span className="text-[var(--katie-blue)]">ARROW</span>
        </h1>
        <p className="text-lg text-white/70 mb-8 max-w-2xl mx-auto">
          Full comparison coming soon. See how whoza.ai&apos;s AI call answering for UK tradespeople compares to ARROW.
        </p>
