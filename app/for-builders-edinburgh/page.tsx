  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: "Builders in Edinburgh", item: "https://whoza.ai/for-builders-edinburgh" },
      ]} />
      <div>
      ...
      <CityTradeSchema trade="Builder" tradePlural="Builders" city="Edinburgh" region="City of Edinburgh" pageUrl="https://whoza.ai/for-builders-edinburgh" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-white/70 leading-relaxed mb-8 max-w-xl">
                  ...
                  Katie ensures you capture every building enquiry — extensions, renovations & new builds.
                </p>
        ...
        <section className="py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <TradeCityLinks trade="for-builders" current="edinburgh" />
            <div className="mt-6">
