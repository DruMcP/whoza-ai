...
export const metadata: Metadata = {
  ...
  description: "Stop losing locksmith jobs to missed calls in Manchester. Katie answers 24/7, captures emergency lockout and key enquiries via WhatsApp. Plans from £59.",
  alternates: {
...
export default function ForLocksmithManchesterPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Locksmith" tradePlural="Locksmiths" city="Manchester" region="Greater Manchester" pageUrl="https://whoza.ai/for-locksmiths-manchester" />
        {/* ─── HERO ─── */}
