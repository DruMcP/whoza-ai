...
export const metadata: Metadata = {
  ...
  description: "Stop losing plasterer jobs to missed calls in Glasgow. Katie answers 24/7, captures skimming and rendering enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
...
export default function ForPlastererGlasgowPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Plasterer" tradePlural="Plasterers" city="Glasgow" region="Greater Glasgow" pageUrl="https://whoza.ai/for-plasterers-glasgow" />
