...
import { ArrowRight, Phone, Bug, Shield, Clock, PoundSterling, CheckCircle2, Star, AlertTriangle, TrendingUp, Users, Home } from "lucide-react"
import Link from "next/link"

export const metadata: Metadata = {
  title: "AI Call Answering for Pest Control in London | whoza.ai",
  description: "Stop losing pest control jobs to missed calls in London. Katie answers 24/7, captures rodent, insect and bird control emergency via WhatsApp. Plans from £59.",
  alternates: {
...
const faqs = [
  {
    "question": "How much does AI call answering cost for pest control in London?",
    "answer": "whoza.ai starts at £59/month for the Starter plan. That's less than one pest control job in London. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most pest control businesses recover the cost within 48 hours by capturing just one missed job."
  },
  {
    "question": "Can Katie handle emergency calls for pest control in London?",
  ...
  {
    "question": "What information does Katie collect from pest control customers in London?",
  ...
  {
    "question": "How quickly can I get set up for pest control in London?",
    "answer": "Most pest control businesses in London are live and capturing calls within 30 minutes. Sign up, connect your number via call forwarding, set your greeting and business details, and Katie starts answering immediately. No hardware, no IT team, no technical knowledge required."
  },
  {
    "question": "What makes whoza.ai different for pest control in London?",
    "answer": "Unlike generic call answering services, Katie is trained specifically for pest control. She understands rodent control, insect removal, bird proofing & prevention — and with 25,000+ trade businesses competing in London, capturing every call gives you a real competitive edge."
  }
]

export const revalidate = 3600

export default function ForPestControlLondonPage() {
  return (
    <>
      <Header />
      <BreadcrumbSchema items={[
        { name: "Home", item: "https://whoza.ai" },
        { name: "Pest Control", item: "https://whoza.ai/for-pest-control" },
        { name: "London", item: "https://whoza.ai/for-pest-control-london" },
      ]} />
      ...
      <main id="main-content" role="main" className="pb-24 lg:pb-0 bg-[var(--navy-900)] text-white">
        <section className="relative overflow-hidden pt-20 pb-16 lg:pt-28 lg:pb-24">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 bg-rose-500/10 text-rose-400 px-4 py-2 rounded-full text-sm font-medium mb-6">
                  <Bug className="w-4 h-4" />
                  Pest Control in London
                </div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-balance mb-6">
                  Never Miss a{" "}
                  <span className="text-rose-400">Pest Control</span>{" "}
                  Job in London Again
                </h1>
                <p className="text-xl text-white/70 leading-relaxed mb-8 max-w-xl">
                  London has 25,000+ trade businesses competing for 3.6M households. 
                  With 11,000 missed calls every week across the city, 
                  Katie ensures you capture every pest control enquiry — rodent control, insect removal, bird proofing & prevention.
                </p>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">London — Pest Control Enquiry</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-rose-500/10 rounded-lg p-3 border-rose-500/20 border">
                      <p className="text-sm text-white/90">"I need pest control urgently in London!"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                London Pest Control Market
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                The numbers that matter for pest control in London.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                { icon: Users, label: "Trade Businesses", value: "25,000+", color: "text-rose-400" },
                { icon: Home, label: "Households", value: "3.6M", color: "text-rose-400" },
                { icon: PoundSterling, label: "Avg Job Value", value: "£280", color: "text-emerald-400" },
                { icon: Phone, label: "Missed Calls/Week", value: "11,000", color: "text-red-400" },
                { icon: TrendingUp, label: "Market Size", value: "£1.2B", color: "text-rose-400" },
              ].map((item, idx) => {
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                The Real Cost of Missed Calls for Pest Control in London
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                Dense urban housing means infestations spread fast. Properties share walls and ventilation — one untreated pest problem becomes an entire building's nightmare.
              </p>
            </div>
            <div className="space-y-8">
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  <div className={`w-12 h-12 rounded-xl bg-rose-500/10 border-rose-500/20 border flex items-center justify-center flex-shrink-0`}>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 leading-relaxed">
                      A customer calls about an urgent issue at 8pm while you're having dinner. They leave a voicemail, then call the next pest control on Google. You lose a £280+ job.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 text-center">
              <p className="text-emerald-200 font-medium text-lg">
                The average London pest controller misses multiple calls per day = 
                <strong> £39,000+</strong> in lost revenue per year
              </p>
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                How Katie Works for Pest Control in London
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                ...
                return (
                  <div key={idx} className="relative">
                    <div className="bg-white/5 border border-white/10 rounded-xl p-8 h-full">
                      ...
                      <div className={`w-12 h-12 rounded-xl bg-rose-500/10 border-rose-500/20 border flex items-center justify-center mb-4`}>
        ...
        <section className="py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">
              AI Call Answering for Pest Control Across the UK
            </h2>
            <p className="text-white/60 mb-6">
              Katie answers calls for pest controllers in cities nationwide. Find your location:
            </p>
            ...
            <div className="mt-6">
              <Link href="/for-pest-control" className="inline-flex items-center text-rose-400 hover:text-rose-300 text-sm font-medium transition-all">
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Questions Pest Controllers in London Ask
              </h2>
              <p className="text-white/60">
                Everything you need to know about AI call answering for pest control in London.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                return (
                  <div key={idx} className="bg-white/5 border border-white/10 rounded-xl p-6 text-center">
                    <Icon className={`w-8 h-8 text-rose-400 mx-auto mb-3`} />
        ...
        <section className="py-16 lg:py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Stop Losing Pest Control Jobs in London Today
            </h2>
