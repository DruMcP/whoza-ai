...
export const metadata: Metadata = {
  ...
  description: "Stop losing electrician jobs to missed calls in Birmingham. Katie answers 24/7, captures emergency and EICR enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
...
export default function ForElectricianBirminghamPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Electrician" tradePlural="Electricians" city="Birmingham" region="West Midlands" pageUrl="https://whoza.ai/for-electricians-birmingham" />
        {/* ─── HERO ─── */}
