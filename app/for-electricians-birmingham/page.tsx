...
import { ArrowRight, Phone, Zap, Shield, Clock, PoundSterling, CheckCircle2, Star, AlertTriangle, MapPin, TrendingUp, Users, Home } from "lucide-react"
import Link from "next/link"

export const metadata: Metadata = {
  title: "AI Call Answering for Electricians in Birmingham | whoza.ai",
  description: "Stop losing electricians jobs to missed calls in Birmingham. Katie answers 24/7, captures EICR enquiries, emergency faults, consumer unit upgrades & power outages, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
  alternates: {
    canonical: "https://whoza.ai/for-electricians-birmingham",
  },
  openGraph: {
    type: "website",
    locale: "en_GB",
    url: "https://whoza.ai/for-electricians-birmingham",
    siteName: "Whoza.ai",
    title: "AI Call Answering for Electricians in Birmingham | whoza.ai",
    description: "Stop losing electricians jobs to missed calls in Birmingham. Katie answers 24/7, captures EICR enquiries, emergency faults, consumer unit upgrades & power outages, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
    images: [{ url: "https://whoza.ai/og-image.webp", width: 1200, height: 630, alt: "whoza.ai — AI Call Answering for Electricians in Birmingham" }],
  },
  twitter: {
...
const faqs = [
  {
    "question": "How much does AI call answering cost for electricians in Birmingham?",
    "answer": "whoza.ai starts at £59/month for the Starter plan. That's less than one electrician job in Birmingham. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most electricians recover the cost within 48 hours by capturing just one missed job."
  },
  {
    "question": "Can Katie handle emergency calls for electricians in Birmingham?",
  ...
  {
    "question": "What information does Katie collect from electricians customers in Birmingham?",
  ...
  {
    "question": "How quickly can I get set up as a electrician in Birmingham?",
    "answer": "Most electricians in Birmingham are live and capturing calls within 30 minutes. Sign up, connect your number via call forwarding, set your greeting and business details, and Katie starts answering immediately. No hardware, no IT team, no technical knowledge required."
  },
  {
    "question": "What makes whoza.ai different for electricians in Birmingham?",
    "answer": "Unlike generic call answering services, Katie is trained specifically for electricians. She understands EICR enquiries, emergency faults, consumer unit upgrades & power outages — and with 11,000+ trade businesses competing in Birmingham, capturing every call gives you a real competitive edge."
  }
]

export const revalidate = 3600

export default function ForElectricianBirminghamPage() {
  return (
    <>
      <Header />
      <BreadcrumbSchema items={[
        ...
        { name: "Birmingham", item: "https://whoza.ai/for-electricians-birmingham" },
      ]} />
      <FAQPageSchema faqs={faqs} />

      {/* Schema JSON-LD */}
      <script
        id="electrician-birmingham-schema"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "FAQPage",
                "mainEntity": [{"@type":"Question","name":"How much does AI call answering cost for electricians in Birmingham?","acceptedAnswer":{"@type":"Answer","text":"whoza.ai starts at £59/month for the Starter plan. That's less than one electrician job in Birmingham. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most electricians recover the cost within 48 hours by capturing just one missed job."}},{"@type":"Question","name":"Can Katie handle emergency calls for electricians in Birmingham?","acceptedAnswer":{"@type":"Answer","text":"Absolutely. Katie answers 24/7, including nights, weekends, and bank holidays. She identifies emergency calls and marks them as highest priority in your WhatsApp alert. Whether you're in Birmingham or anywhere in the UK, you'll see the emergency tag immediately and can respond within minutes."}},{"@type":"Question","name":"What information does Katie collect from electricians customers in Birmingham?","acceptedAnswer":{"@type":"Answer","text":"Katie captures: full name, phone number, Birmingham postcode, property type, job description, urgency level, preferred appointment time, and how they found you. For emergencies, she also asks about immediate safety concerns and property damage extent."}},{"@type":"Question","name":"Does it work with my existing Birmingham business phone number?","acceptedAnswer":{"@type":"Answer","text":"Yes. You simply set up call forwarding from your existing Birmingham business number to your whoza.ai number. Your customers dial the same number they've always used — Katie answers when you can't. Setup takes under 10 minutes and works with both mobile and landline numbers."}},{"@type":"Question","name":"How quickly can I get set up as a electrician in Birmingham?","acceptedAnswer":{"@type":"Answer","text":"Most electricians in Birmingham are live and capturing calls within 30 minutes. Sign up, connect your number via call forwarding, set your greeting and business details, and Katie starts answering immediately. No hardware, no IT team, no technical knowledge required."}},{"@type":"Question","name":"What makes whoza.ai different for electricians in Birmingham?","acceptedAnswer":{"@type":"Answer","text":"Unlike generic call answering services, Katie is trained specifically for electricians. She understands EICR enquiries, emergency faults, consumer unit upgrades & power outages — and with 11,000+ trade businesses competing in Birmingham, capturing every call gives you a real competitive edge."}}]
              },
              {
                "@type": "LocalBusiness",
                "name": "whoza.ai - AI Call Answering for Electricians in Birmingham",
                "address": {
                  "@type": "PostalAddress",
              ...
              {
                "@type": "Service",
                "serviceType": "AI Call Answering for Electricians",
                "areaServed": {
                  "@type": "City",
                  "name": "Birmingham"
                }
              },
              {
                ...
                "itemListElement": [
                  ...
                  { "@type": "ListItem", "position": 3, "name": "Birmingham", "item": "https://whoza.ai/for-electricians-birmingham" }
                ]
              }
            ]
          })
      ...
      <main id="main-content" role="main" className="pb-24 lg:pb-0 bg-[var(--navy-900)] text-white">
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">Birmingham — Electrician Enquiry</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-amber-500/10 rounded-lg p-3 border-amber-500/20 border">
                      <p className="text-sm text-white/90">"I need a electrician urgently in Birmingham!"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Birmingham Electricians Market
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                The numbers that matter for electricians in Birmingham.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                { icon: Users, label: "Trade Businesses", value: "11,000+", color: "text-amber-400" },
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                The Real Cost of Missed Calls for Electricians in Birmingham
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 leading-relaxed">
                      You're on a commercial job doing a three-phase upgrade. Phone is on silent in the van. Missed 3 calls: one consumer unit upgrade (£850), one EV charger installation (£1,200), and one EICR for a landlord with 6 properties.
                    </p>
                  </div>
                </div>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 leading-relaxed">
                      Family sitting in the dark with no heating in winter. They call you first because you have great reviews. You don't answer. They call the next electrician on Google who picks up immediately.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 text-center">
              <p className="text-emerald-200 font-medium text-lg">
                The average Birmingham electrician misses multiple calls per day = 
                <strong> £43,680</strong> in lost revenue per year
              </p>
              <p className="text-emerald-200/70 text-sm mt-1">
                Based on £350 avg job value with 35% conversion rate
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                How Katie Works for Electricians in Birmingham
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                More Electricians Locations
              </h2>
              <p className="text-white/60">
                Katie answers calls for electricians across the UK.
              </p>
            </div>
            <div className="flex flex-wrap justify-center gap-3">
              {["London", "Manchester", "Birmingham", "Glasgow", "Bristol", "Liverpool", "Leeds", "Edinburgh"].map(city => (
                <Link
                  key={city}
                  href={`/for-electricians-${city.toLowerCase().replace(/\s+/g, '-')}`}
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Questions Electricians in Birmingham Ask
              </h2>
              <p className="text-white/60">
                Everything you need to know about AI call answering for electricians in Birmingham.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Stop Losing Electrician Jobs in Birmingham Today
            </h2>
