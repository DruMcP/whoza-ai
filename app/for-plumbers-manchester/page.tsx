...
export const metadata: Metadata = {
  ...
  description: "Stop losing plumber jobs to missed calls in Manchester. Katie answers 24/7, captures burst pipe and boiler enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
...
export default function ForPlumberManchesterPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Plumber" tradePlural="Plumbers" city="Manchester" region="Greater Manchester" pageUrl="https://whoza.ai/for-plumbers-manchester" />
        {/* ─── HERO ─── */}
