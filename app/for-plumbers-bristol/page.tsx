...
export const metadata: Metadata = {
  ...
  description: "Stop losing plumber jobs to missed calls in Bristol. Katie answers 24/7, captures burst pipe and boiler enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
...
export default function ForPlumberBristolPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Plumber" tradePlural="Plumbers" city="Bristol" region="City of Bristol" pageUrl="https://whoza.ai/for-plumbers-bristol" />
        {/* ─── HERO ─── */}
