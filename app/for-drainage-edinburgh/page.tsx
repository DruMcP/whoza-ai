...
export default function ForDrainageEngineerEdinburghPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Drainage Specialist" tradePlural="Drainage Specialists" city="Edinburgh" region="City of Edinburgh" pageUrl="https://whoza.ai/for-drainage-edinburgh" />
