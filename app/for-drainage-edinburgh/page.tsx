...
export const metadata: Metadata = {
  ...
  description: "Stop losing drainage jobs to missed calls in Edinburgh. Katie answers 24/7, captures blocked drain and flood enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
