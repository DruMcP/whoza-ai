...
export const metadata: Metadata = {
  title: "AI Call Handling for Heating Engineers — Never Miss a Boiler Job | whoza.ai",
  ...
  openGraph: {
    ...
    siteName: "Whoza.ai",
    title: "AI Call Handling for Heating Engineers — Never Miss a Boiler Job",
    description: "Stop losing boiler breakdown calls to voicemail. Katie answers 24/7 for emergency heating, annual services & breakdowns. WhatsApp alerts in 3 seconds. 7-day free trial.",
        ...
        <section className="section-padding-lg bg-white relative">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="mt-6 text-lg text-[var(--slate-500)] max-w-2xl mx-auto">
                Four simple steps from missed call to booked callout. Katie handles the conversation. You handle the heating.
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                ...
                <Link href="/blog/hvac-emergency-call-handling" className="px-4 py-2 bg-[var(--off-white)] border border-[var(--border)] rounded-lg text-[var(--navy-900)] hover:bg-[var(--katie-blue)]/10 hover:border-[var(--katie-blue)]/30 transition-colors text-sm">
