...
const faqs = [
  {
    "question": "How much does AI call answering cost for electricians in London?",
    "answer": "whoza.ai starts at £59/month for the Starter plan. That's less than one electrician job in London. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most electricians recover the cost within 48 hours by capturing just one missed job."
  },
  {
    "question": "Can Katie handle emergency calls for electricians in London?",
  ...
  {
    "question": "What information does Katie collect from electricians customers in London?",
  ...
  {
    "question": "What makes whoza.ai different for electricians in London?",
    "answer": "Unlike generic call answering services, Katie is trained specifically for electricians. She understands EICR enquiries, emergency faults, consumer unit upgrades & power outages — and with 32,000+ trade businesses competing in London, capturing every call gives you a real competitive edge."
  }
]

export const revalidate = 3600

export default function ForElectricianLondonPage() {
  return (
    <>
      <Header />
      <BreadcrumbSchema items={[
        ...
        { name: "London", item: "https://whoza.ai/for-electricians-london" },
      ]} />
      <FAQPageSchema faqs={faqs} />

      {/* Schema JSON-LD */}
      <script
        id="electrician-london-schema"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "FAQPage",
                "mainEntity": [{"@type":"Question","name":"How much does AI call answering cost for electricians in London?","acceptedAnswer":{"@type":"Answer","text":"whoza.ai starts at £59/month for the Starter plan. That's less than one electrician job in London. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most electricians recover the cost within 48 hours by capturing just one missed job."}},{"@type":"Question","name":"Can Katie handle emergency calls for electricians in London?","acceptedAnswer":{"@type":"Answer","text":"Absolutely. Katie answers 24/7, including nights, weekends, and bank holidays. She identifies emergency calls and marks them as highest priority in your WhatsApp alert. Whether you're in London or anywhere in the UK, you'll see the emergency tag immediately and can respond within minutes."}},{"@type":"Question","name":"What information does Katie collect from electricians customers in London?","acceptedAnswer":{"@type":"Answer","text":"Katie captures: full name, phone number, London postcode, property type, job description, urgency level, preferred appointment time, and how they found you. For emergencies, she also asks about immediate safety concerns and property damage extent."}},{"@type":"Question","name":"Does it work with my existing London business phone number?","acceptedAnswer":{"@type":"Answer","text":"Yes. You simply set up call forwarding from your existing London business number to your whoza.ai number. Your customers dial the same number they've always used — Katie answers when you can't. Setup takes under 10 minutes and works with both mobile and landline numbers."}},{"@type":"Question","name":"How quickly can I get set up as a electrician in London?","acceptedAnswer":{"@type":"Answer","text":"Most electricians in London are live and capturing calls within 30 minutes. Sign up, connect your number via call forwarding, set your greeting and business details, and Katie starts answering immediately. No hardware, no IT team, no technical knowledge required."}},{"@type":"Question","name":"What makes whoza.ai different for electricians in London?","acceptedAnswer":{"@type":"Answer","text":"Unlike generic call answering services, Katie is trained specifically for electricians. She understands EICR enquiries, emergency faults, consumer unit upgrades & power outages — and with 32,000+ trade businesses competing in London, capturing every call gives you a real competitive edge."}}]
              },
              {
                "@type": "LocalBusiness",
                "name": "whoza.ai - AI Call Answering for Electricians in London",
                "address": {
                  "@type": "PostalAddress",
      ...
      <CityTradeSchema trade="Electrician" tradePlural="Electricians" city="London" region="Greater London" pageUrl="https://whoza.ai/for-electricians-london" />
        {/* ─── HERO ─── */}
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">London — Electrician Enquiry</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-amber-500/10 rounded-lg p-3 border-amber-500/20 border">
                      <p className="text-sm text-white/90">"I need a electrician urgently in London!"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                London Electricians Market
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                The numbers that matter for electricians in London.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                { icon: Users, label: "Trade Businesses", value: "32,000+", color: "text-amber-400" },
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                The Real Cost of Missed Calls for Electricians in London
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
            ...
            <div className="mt-8 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 text-center">
              <p className="text-emerald-200 font-medium text-lg">
                The average London electrician misses multiple calls per day = 
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                How Katie Works for Electricians in London
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Questions Electricians in London Ask
              </h2>
              <p className="text-white/60">
        ...
        <section className="py-16 lg:py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Stop Losing Electrician Jobs in London Today
            </h2>
