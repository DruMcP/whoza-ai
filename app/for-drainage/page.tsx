...
import { ArrowRight, Phone, Droplets, Clock, PoundSterling, Shield, CheckCircle2, Star, Waves, AlertTriangle, Building2 } from "lucide-react"
...
export const metadata: Metadata = {
  title: "Call Answering Service for Drainage Engineers | From £59",
  description: "24/7 call answering for UK drainage engineers. Every flood, blockage and emergency call captured and sent to your WhatsApp in 3 seconds. From £59.",
  alternates: {
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Katie introduces herself as your digital assistant with a natural, professional voice. Most callers appreciate the instant response over voicemail or a ringing phone. Most callers are satisfied with the AI experience — they just want their flooding or blocked drain fixed fast.",
  },
  {
...
<section className="py-12 border-t border-white/10">
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid sm:grid-cols-3 gap-4">
      ...
      <div className="section-divider" />
        <RelatedTrades currentTrade="for-drainage" />
        <Footer />
    </>
  )
}
