    ...
    <>
      ...
      <FAQPageSchema
        items={[
          ...
          { question: "Is my data safe and compliant?", answer: "Absolutely. We're fully compliant with all relevant data protection regulations. All call transcripts and customer data are encrypted, stored in secure local data centers, and you maintain full control." },
          ...
          { question: "Can I choose a different voice for my AI?", answer: "Absolutely. We offer 12 AI voice options (UK accents) with a range of tones — from Scottish to Welsh to London. You can preview and change your voice anytime in your dashboard." },
