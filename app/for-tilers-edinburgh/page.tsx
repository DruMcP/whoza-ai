...
export const metadata: Metadata = {
  ...
  description: "Stop losing tiler jobs to missed calls in Edinburgh. Katie answers 24/7, captures bathroom and kitchen tiling enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
...
export default function ForTilerEdinburghPage() {
  return (
    <>
      ...
      <CityTradeSchema trade="Tiler" tradePlural="Tilers" city="Edinburgh" region="City of Edinburgh" pageUrl="https://whoza.ai/for-tilers-edinburgh" />
