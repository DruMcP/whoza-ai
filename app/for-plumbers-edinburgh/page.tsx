...
export const metadata: Metadata = {
  ...
  description: "Stop losing plumbers jobs to missed calls in Edinburgh. Katie answers 24/7, captures burst pipes, boiler breakdowns, leaks & no water, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
  alternates: {
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "LocalBusiness",
                "name": "whoza.ai - AI Call Answering for Plumbers in Edinburgh",
                "address": {
                  "@type": "PostalAddress",
              ...
              },
              {
                ...
                "itemListElement": [
                  ...
                  { "@type": "ListItem", "position": 3, "name": "Edinburgh", "item": "https://whoza.ai/for-plumbers-edinburgh" }
                ]
              }
            ]
          })
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">Edinburgh — Plumber Enquiry</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-blue-500/10 rounded-lg p-3 border-blue-500/20 border">
                      <p className="text-sm text-white/90">"I need a plumber urgently in Edinburgh!"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3">
