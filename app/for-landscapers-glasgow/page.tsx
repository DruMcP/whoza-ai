...
import { ArrowRight, Phone, TreePine, Shield, Clock, PoundSterling, CheckCircle2, Star, AlertTriangle, TrendingUp, Users, Home } from "lucide-react"
import Link from "next/link"

export const metadata: Metadata = {
  title: "AI Call Answering for Landscapers in Glasgow | whoza.ai",
  description: "Stop losing landscaper jobs to missed calls in Glasgow. Katie answers 24/7, captures garden and maintenance enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
    canonical: "https://whoza.ai/for-landscapers-glasgow",
  },
  openGraph: {
    type: "website",
    locale: "en_GB",
    url: "https://whoza.ai/for-landscapers-glasgow",
    siteName: "Whoza.ai",
    title: "AI Call Answering for Landscapers in Glasgow | whoza.ai",
    description: "Stop losing landscaper jobs to missed calls in Glasgow. Katie answers 24/7, captures garden and maintenance enquiries via WhatsApp. Plans from £59/month.",
    images: [{ url: "https://whoza.ai/og-image.webp", width: 1200, height: 630, alt: "whoza.ai — AI Call Answering for Landscapers in Glasgow" }],
  },
  twitter: {
...
const faqs = [
  {
    "question": "How much does AI call answering cost for landscapers in Glasgow?",
    "answer": "whoza.ai starts at £59/month for the Starter plan. That's less than one landscaper job in Glasgow. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most landscapers recover the cost within 48 hours by capturing just one missed job."
  },
  {
    "question": "Can Katie handle emergency calls for landscapers in Glasgow?",
  ...
  {
    "question": "What information does Katie collect from landscapers customers in Glasgow?",
  ...
  {
    "question": "How quickly can I get set up as a landscaper in Glasgow?",
    "answer": "Most landscapers in Glasgow are live and capturing calls within 30 minutes. Sign up, connect your number via call forwarding, set your greeting and business details, and Katie starts answering immediately. No hardware, no IT team, no technical knowledge required."
  },
  {
    "question": "What makes whoza.ai different for landscapers in Glasgow?",
    "answer": "Unlike generic call answering services, Katie is trained specifically for landscapers. She understands garden design, patios, decking, fencing & maintenance — and with 5,500+ trade businesses competing in Glasgow, capturing every call gives you a real competitive edge."
  }
]

export const revalidate = 3600

export default function ForLandscaperGlasgowPage() {
  return (
    <>
      <Header />
      <BreadcrumbSchema items={[
        ...
        { name: "Glasgow", item: "https://whoza.ai/for-landscapers-glasgow" },
      ]} />
      <FAQPageSchema faqs={faqs} />

      <script
        id="landscapers-glasgow-schema"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "LocalBusiness",
                "name": "whoza.ai - AI Call Answering for Landscapers in Glasgow",
                "address": {
                  "@type": "PostalAddress",
      ...
      <CityTradeSchema trade="Landscaper" tradePlural="Landscapers" city="Glasgow" region="Greater Glasgow" pageUrl="https://whoza.ai/for-landscapers-glasgow" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-white/70 leading-relaxed mb-8 max-w-xl">
                  ...
                  Katie ensures you capture every landscapers enquiry — garden design, patios, decking, fencing & maintenance.
                </p>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">Glasgow — Landscaper Enquiry</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-green-500/10 rounded-lg p-3 border-green-500/20 border">
                      <p className="text-sm text-white/90">"I need a landscaper urgently in Glasgow!"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Glasgow Landscapers Market
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                The numbers that matter for landscapers in Glasgow.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                { icon: Users, label: "Trade Businesses", value: "5,500+", color: "text-green-400" },
                { icon: Home, label: "Households", value: "310K", color: "text-green-400" },
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                The Real Cost of Missed Calls for Landscapers in Glasgow
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 leading-relaxed">
                      A customer calls about an urgent issue at 8pm while you're having dinner. They leave a voicemail, then call the next landscaper on Google. You lose a £290+ job.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 text-center">
              <p className="text-emerald-200 font-medium text-lg">
                The average Glasgow landscaper misses multiple calls per day = 
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                How Katie Works for Landscapers in Glasgow
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
        ...
        <section className="py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">
              AI Call Answering for Landscapers Across the UK
            </h2>
            <p className="text-white/60 mb-6">
              Katie answers calls for landscapers in cities nationwide. Find your location:
            </p>
            ...
            <div className="mt-6">
              <Link href="/for-landscapers" className="inline-flex items-center text-green-400 hover:text-green-300 text-sm font-medium transition-all">
                View all Landscapers →
              </Link>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Questions Landscapers in Glasgow Ask
              </h2>
              <p className="text-white/60">
                Everything you need to know about AI call answering for landscapers in Glasgow.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Stop Losing Landscaper Jobs in Glasgow Today
            </h2>
