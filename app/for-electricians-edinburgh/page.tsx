...
export const metadata: Metadata = {
  ...
  description: "Stop losing electricians jobs to missed calls in Edinburgh. Katie answers 24/7, captures power outages, electrical faults, tripped circuits & safety issues, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
  alternates: {
...
const faqs = [
  ...
  {
    "question": "How quickly can I get set up as a electrician in Edinburgh?",
...
export default function ForElectricianEdinburghPage() {
  return (
    <>
      ...
      <script
        id="electricians-edinburgh-schema"
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "LocalBusiness",
                "name": "whoza.ai - AI Call Answering for Electricians in Edinburgh",
                "address": {
                  "@type": "PostalAddress",
              ...
              },
              {
                ...
                "itemListElement": [
                  ...
                  { "@type": "ListItem", "position": 3, "name": "Edinburgh", "item": "https://whoza.ai/for-electricians-edinburgh" }
                ]
              }
            ]
          })
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">Edinburgh — Electrician Enquiry</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-yellow-500/10 rounded-lg p-3 border-yellow-500/20 border">
                      <p className="text-sm text-white/90">"I need a electrician urgently in Edinburgh!"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3">
