...
export const metadata: Metadata = {
  title: "AI Call Answering for Builders in London | whoza.ai",
  description: "Stop losing builders jobs to missed calls in London. Katie answers 24/7, captures extension enquiries, renovation quotes, new build leads & commercial contracts, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
  alternates: {
    canonical: "https://whoza.ai/for-builders-london",
  },
  openGraph: {
    type: "website",
    locale: "en_GB",
    url: "https://whoza.ai/for-builders-london",
    siteName: "Whoza.ai",
    title: "AI Call Answering for Builders in London | whoza.ai",
    description: "Stop losing builders jobs to missed calls in London. Katie answers 24/7, captures extension enquiries, renovation quotes, new build leads & commercial contracts, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
    images: [{ url: "https://whoza.ai/og-image.webp", width: 1200, height: 630, alt: "whoza.ai — AI Call Answering for Builders in London" }],
  },
  twitter: {
...
const faqs = [
  {
    "question": "How much does AI call answering cost for builders in London?",
    "answer": "whoza.ai starts at £59/month for the Starter plan. That's less than one builder job in London. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most builders recover the cost within 48 hours by capturing just one missed job."
  },
  {
    "question": "Can Katie handle emergency calls for builders in London?",
  ...
  {
    "question": "What information does Katie collect from builders customers in London?",
  ...
  {
    "question": "How quickly can I get set up as a builder in London?",
    "answer": "Most builders in London are live and capturing calls within 30 minutes. Sign up, connect your number via call forwarding, set your greeting and business details, and Katie starts answering immediately. No hardware, no IT team, no technical knowledge required."
  },
  {
    "question": "What makes whoza.ai different for builders in London?",
    "answer": "Unlike generic call answering services, Katie is trained specifically for builders. She understands extension enquiries, renovation quotes, new build leads & commercial contracts — and with 32,000+ trade businesses competing in London, capturing every call gives you a real competitive edge."
  }
]

export const revalidate = 3600

export default function ForBuilderLondonPage() {
  return (
    <>
      <Header />
      <BreadcrumbSchema items={[
        ...
        { name: "London", item: "https://whoza.ai/for-builders-london" },
      ]} />
            ...
            "@graph": [
              ...
              },
              {
                ...
                "itemListElement": [
                  ...
                  { "@type": "ListItem", "position": 3, "name": "London", "item": "https://whoza.ai/for-builders-london" }
                ]
              }
            ]
          })
      ...
      <main id="main-content" role="main" className="pb-24 lg:pb-0 bg-[var(--navy-900)] text-white">
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">London — Builder Enquiry</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-orange-500/10 rounded-lg p-3 border-orange-500/20 border">
                      <p className="text-sm text-white/90">"I need a builder urgently in London!"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                London Builders Market
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                The numbers that matter for builders in London.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                The Real Cost of Missed Calls for Builders in London
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
            ...
            <div className="mt-8 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 text-center">
              <p className="text-emerald-200 font-medium text-lg">
                The average London builder misses multiple calls per day = 
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                How Katie Works for Builders in London
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Questions Builders in London Ask
              </h2>
              <p className="text-white/60">
                Everything you need to know about AI call answering for builders in London.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Stop Losing Builder Jobs in London Today
            </h2>
