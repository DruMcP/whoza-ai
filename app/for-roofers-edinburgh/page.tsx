...
export const metadata: Metadata = {
  ...
  description: "Stop losing roofer jobs to missed calls in Edinburgh. Katie answers 24/7, captures storm damage and repair enquiries via WhatsApp. Plans from £59/month.",
  alternates: {
