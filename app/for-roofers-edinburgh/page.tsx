...
export const metadata: Metadata = {
  ...
  description: "Stop losing roofers jobs to missed calls in Edinburgh. Katie answers 24/7, captures storm damage, active leaks & emergency repairs, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
  alternates: {
    canonical: "https://whoza.ai/for-roofers-edinburgh",
  },
  openGraph: {
    type: "website",
    locale: "en_GB",
    url: "https://whoza.ai/for-roofers-edinburgh",
    siteName: "Whoza.ai",
    title: "AI Call Answering for Roofers in Edinburgh | whoza.ai",
    description: "Stop losing roofers jobs to missed calls in Edinburgh. Katie answers 24/7, captures storm damage, active leaks & emergency repairs, and sends WhatsApp alerts in 3 seconds. 7-day free trial.",
    images: [{ url: "https://whoza.ai/og-image.webp", width: 1200, height: 630, alt: "whoza.ai — AI Call Answering for Roofers in Edinburgh" }],
  },
  twitter: {
...
const faqs = [
  {
    "question": "How much does AI call answering cost for roofers in Edinburgh?",
    "answer": "whoza.ai starts at £59/month for the Starter plan. That's less than one roofer job in Edinburgh. Every plan includes unlimited AI calls, WhatsApp delivery, and a 7-day free trial. Most roofers recover the cost within 48 hours by capturing just one missed job."
  },
  {
    "question": "Can Katie handle emergency calls for roofers in Edinburgh?",
  ...
  {
    "question": "What information does Katie collect from roofers customers in Edinburgh?",
  ...
  {
    "question": "How quickly can I get set up as a roofer in Edinburgh?",
    "answer": "Most roofers in Edinburgh are live and capturing calls within 30 minutes. Sign up, connect your number via call forwarding, set your greeting and business details, and Katie starts answering immediately. No hardware, no IT team, no technical knowledge required."
  },
  {
    "question": "What makes whoza.ai different for roofers in Edinburgh?",
    "answer": "Unlike generic call answering services, Katie is trained specifically for roofers. She understands storm damage, slipped tiles, leak emergencies & full re-roof quotes — and with 4,500+ trade businesses competing in Edinburgh, capturing every call gives you a real competitive edge."
  }
]

export const revalidate = 3600

export default function ForRooferEdinburghPage() {
  return (
    <>
      <Header />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@graph": [
              ...
              {
                "@type": "LocalBusiness",
                "name": "whoza.ai - AI Call Answering for Roofers in Edinburgh",
                "address": {
                  "@type": "PostalAddress",
              ...
              },
              {
                ...
                "itemListElement": [
                  ...
                  { "@type": "ListItem", "position": 3, "name": "Edinburgh", "item": "https://whoza.ai/for-roofers-edinburgh" }
                ]
              }
            ]
          })
      ...
      <main id="main-content" role="main" className="pb-24 lg:pb-0 bg-[var(--navy-900)] text-white">
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-white/50">Edinburgh — Roofer Enquiry</p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-slate-500/10 rounded-lg p-3 border-slate-500/20 border">
                      <p className="text-sm text-white/90">"I need a roofer urgently in Edinburgh!"</p>
                    </div>
                    <div className="bg-white/5 rounded-lg p-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Edinburgh Roofers Market
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                The numbers that matter for roofers in Edinburgh.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                { icon: Users, label: "Trade Businesses", value: "4,500+", color: "text-slate-400" },
                { icon: Home, label: "Households", value: "245K", color: "text-slate-400" },
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                The Real Cost of Missed Calls for Roofers in Edinburgh
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 leading-relaxed">
                      A customer calls about an urgent issue at 8pm while you're having dinner. They leave a voicemail, then call the next roofer on Google. You lose a £315+ job.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-8 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 text-center">
              <p className="text-emerald-200 font-medium text-lg">
                The average Edinburgh roofer misses multiple calls per day = 
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                How Katie Works for Roofers in Edinburgh
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Questions Roofers in Edinburgh Ask
              </h2>
              <p className="text-white/60">
                Everything you need to know about AI call answering for roofers in Edinburgh.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">
              Stop Losing Roofer Jobs in Edinburgh Today
            </h2>
