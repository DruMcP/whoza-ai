import{r as e,j as i,L as a}from"./react-vendor-ZcgRNTHg.js";import{I as o}from"./Icon-C7JlC7fp.js";import"./vendor-B34o3dbG.js";import"./analytics-vendor--TX1veYW.js";import"./SearchIcon-DSBsQEQf.js";import"./ExternalLinkIcon-sbzSRH0N.js";function f(){const[n,s]=e.useState(!1);return e.useEffect(()=>{const t=()=>{const r=window.scrollY;s(r>500)};return window.addEventListener("scroll",t),()=>{window.removeEventListener("scroll",t)}},[]),n?i.jsxs("div",{style:{position:"fixed",bottom:0,left:0,right:0,backgroundColor:"rgba(15, 23, 42, 0.95)",backdropFilter:"blur(10px)",borderTop:"2px solid var(--color-primary-600)",boxShadow:"0 -4px 20px rgba(0, 0, 0, 0.3)",padding:"var(--spacing-md) var(--spacing-lg)",zIndex:999,animation:"slideUp 0.3s ease-out",display:"flex",alignItems:"center",justifyContent:"space-between",gap:"var(--spacing-md)",flexWrap:"wrap"},children:[i.jsxs("div",{style:{flex:"1",minWidth:"200px",color:"white"},children:[i.jsx("div",{style:{fontSize:"18px",fontWeight:600,marginBottom:"4px"},children:"Ready to improve your AI visibility?"}),i.jsx("div",{style:{fontSize:"14px",color:"#F3F4F6"},children:"Get your free Visibility Confidence Score™ in 60 seconds"})]}),i.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--spacing-md)",flexWrap:"wrap"},children:[i.jsxs("div",{style:{fontSize:"14px",color:"#84CC16",fontWeight:600,display:"flex",alignItems:"center",gap:"6px"},children:[i.jsx(o,{name:"check-circle",size:18}),"From £59/month"]}),i.jsxs(a,{to:"/free-score",className:"button btn-hover",style:{fontSize:"16px",padding:"var(--spacing-sm) var(--spacing-lg)",display:"inline-flex",alignItems:"center",gap:"var(--spacing-sm)",whiteSpace:"nowrap"},children:["See if AI would recommend you",i.jsx(o,{name:"arrow-right",size:18})]})]}),i.jsx("style",{children:`
        @keyframes slideUp {
          from {
...
//# sourceMappingURL=StickyCTABar-D77t2eL2.js.map
