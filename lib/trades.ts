...
export const trades: TradeData[] = [
  {
    ...
    faqs: [
      { question: "How much does AI call handling cost for a plumber?", answer: "Whoza starts at £59/month for the Starter plan. That's less than the cost of one missed emergency call. Every plan includes unlimited AI calls, WhatsApp delivery, and 7-day free trial. Overage minutes are £0.40/minute." },
