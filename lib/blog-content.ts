...
If you are a plumber, gas engineer, sparky, roofer, or builder and you are sick of watching money go down the drain because you cannot answer the phone while you are working, just try the free week. No card. No commitment. Do the maths yourself. Link below. Now I am off to service a boiler in Leytonstone.`,
  ...
  "ai-call-answering-cost-uk": {
    ...
    content: {
      introduction: `How much does AI call answering cost in the UK? This is the first question every tradesperson asks me. And the answer surprises them: less than a coffee per day. For £59 per month, you get a 24/7 receptionist that answers every call you miss, qualifies every enquiry, and delivers the details to your WhatsApp in 3 seconds.\n\nIn this guide, I break down the complete cost structure of AI call answering for UK trade businesses. I compare plans, calculate ROI, and show you exactly how much money you will make back. For the full picture of how AI call answering works, see our [Complete Guide](https://whoza.ai/blog/ai-call-answering-uk-tradespeople-definitive-guide-2026). For a comparison with human receptionists, read our [AI vs Human Receptionist](https://whoza.ai/ai-vs-virtual-receptionist) article.`,
      sections: [
        {
      ...
      faq: [
        {
          ...
          answer: "Industry data shows UK tradespeople miss 35-45% of daytime calls and roughly half of after-hours calls. For a tradesperson receiving 20 calls per week, that is 7-12 missed calls weekly. Most tradespeople underestimate their missed calls by 60-70%.",
        },
        {
...
Option 2: Voicemail. Miss 69% of callers who hang up. Cost: £0. But you are invisible to most customers.
      ...
      faq: [
        {
          ...
          answer: "Six key reasons: voicemail is ineffective (69% hang up), human receptionists cannot handle call spikes, AI now sounds human, WhatsApp delivery matches trades workflow, AI costs 95% less than human staff, and customers expect instant response. The 7-day free trial removes all adoption risk.",
        },
        {
