...
export const locations: LocationData[] = [
  ...
  },
  {
    ...
    cityContext: {
      housingStock: "Edinburgh's housing stock is among the most architecturally significant in the UK, with the entire city centre designated a UNESCO World Heritage Site. The Georgian New Town — built between 1767 and 1850 — contains over 3,000 listed buildings with distinctive features: sash-and-case windows, classical proportions, communal gardens, and original period details that demand specialist conservation skills. These properties typically have cellars, multiple storeys, and shared party walls that create complex plumbing and drainage challenges. The medieval Old Town presents an entirely different profile: tenement buildings up to 12 storeys high (some of the world's first high-rises), narrow closes and wynds, and buildings that have evolved over 500 years with layers of modifications. Victorian suburbs like Marchmont, Bruntsfield and Morningside feature blonde sandstone tenements with bay windows, original fireplaces, and high ceilings that require sympathetic renovation. Leith — Edinburgh's port district — has a mix of industrial heritage buildings, sailors' tenements, and modern waterfront regeneration. The city's hilly terrain means properties at different elevations face different exposures: south-facing slopes in Morningside get significantly more sun and heat, while north-facing tenements in Stockbridge struggle with damp and mould. This architectural diversity means Edinburgh trades need an unusually broad skill set, from lime mortar pointing in Georgian basements to modern smart-home wiring in new-build developments.",
      weatherImpact: "Edinburgh's east coast position gives it a markedly different climate from Glasgow — drier, colder, and windier. The city receives only 700mm of annual rainfall (half of Glasgow's), but what rain does fall is often driven horizontally by fierce easterly winds that test every roof, window, and pointing joint. Winter temperatures regularly drop below freezing, with the city's elevated position and exposure to North Sea air masses creating harsh conditions from November through March. The 'Haar' — a cold sea fog that rolls in from the Firth of Forth — is a distinctive Edinburgh phenomenon that can drop temperatures 10°C in an hour and creates persistent damp conditions in coastal areas like Leith and Portobello. Summer is brief and rarely hot, but when heatwaves do occur, the city's stone buildings act as thermal stores, remaining cool initially then releasing heat at night and making sleep difficult. Edinburgh trades report that winter boiler breakdowns are their biggest emergency category, with call volumes tripling during cold snaps. The city's steep streets and staircases make emergency callouts physically demanding in icy conditions, and the narrow lanes of the Old Town can be impassable for vans during snow. The Festival season (August) brings its own weather challenge — sudden summer storms coinciding with peak tourist occupancy create emergency plumbing and electrical demands at the worst possible time.",
      permittingNotes: "Edinburgh operates within one of the most restrictive planning environments in the UK. The UNESCO World Heritage Site designation covers the entire city centre, imposing strict controls on external alterations, roof materials, window styles, and signage. Historic Environment Scotland oversees listed building consent for approximately 4,500 listed structures, with even minor repairs potentially requiring approval. The city has 49 Conservation Areas — the highest number in Scotland — including the New Town, Old Town, Dean Village, and parts of Leith. The Edinburgh City Council planning department is known for being thorough but slow, with listed building applications often taking 8-12 weeks. Party Wall Act considerations are universal in tenement areas, where shared structures, communal stairs, and mutual roofs require neighbour agreement for most work. Building standards in Scotland differ from England, with the Scottish Building Standards applying to all work. Gas Safe registration is essential, but Edinburgh also has specific requirements for work in communal tenement closes where ventilation and access are restricted. The city's net-zero 2030 target is driving new energy efficiency requirements, with some Conservation Areas now mandating sympathetic secondary glazing rather than UPVC replacement. Fire safety regulations following recent high-rise incidents have introduced strict material specifications for cladding and insulation work, particularly relevant to the city's taller tenements.",
      marketDynamics: "Edinburgh's trade market is shaped by its unique demographic and economic profile. Average job values of £315 are among the highest outside London, driven by affluent professional households, a large student population, and a thriving short-term rental market. The city's status as Scotland's capital and a major tourist destination creates a distinctive 'Festival economy' — every August, Edinburgh's population swells by over 1 million visitors, and short-term rental properties require rapid-response trades for emergency repairs between bookings. The Airbnb market is enormous: an estimated 8,000+ short-term rental properties need constant maintenance, with property managers demanding same-day response for urgent issues. The student market — centred around the University of Edinburgh, Napier University, and Heriot-Watt — creates seasonal demand peaks at term starts and ends. Edinburgh's professional class, concentrated in the New Town, Stockbridge and Morningside, values reliability and quality over lowest price, and they're willing to pay premium rates for trades who communicate well. The conservation trade market is particularly lucrative: Georgian restoration specialists command £150-£200 per hour, and there's sustained demand for lime mortar pointing, sash window restoration, and traditional leadwork. With 2,200 missed calls weekly, Edinburgh tradespeople are losing an estimated £28M annually. The trades who understand the city's unique property stock and can respond promptly command waiting lists and premium rates.",
      tradeShortage: "Edinburgh faces acute shortages in conservation and heritage trades. Stonemasons who can work with Craigleith, Hailes and Darney sandstone are critically scarce — the city's traditional building skills are diminishing as experienced workers retire. Sash-and-case window specialists who can restore rather than replace original Georgian and Victorian windows are in extremely high demand. Qualified electricians who understand the challenges of older wiring systems in listed buildings — particularly the New Town's concealed conduit systems and the Old Town's ad-hoc modifications — are hard to find. Gas engineers who can work on the complex communal heating systems in tenement closes are similarly scarce. The city's construction sector is booming with developments like the St James Quarter and ongoing waterfront regeneration, but the domestic conservation market is particularly underserved. The construction skills gap in Edinburgh and the Lothians is estimated at 6,000 workers. This shortage means tradespeople with the right skills can be selective about work and charge premium rates — making missed calls particularly costly."
    },
    caseStudies: [
      {
        ...
        trade: "Plumber",
        area: "Stockbridge",
        story: "Eleanor specialises in emergency plumbing across Edinburgh's New Town and Stockbridge, handling burst pipes, boiler failures, and drainage issues in Georgian properties. Her work is unpredictable — she might spend hours under a sink in a basement flat on India Street, completely unable to answer her phone. The Festival season is her nightmare: short-term rental properties have zero tolerance for plumbing issues, and property managers call every plumber on their list until someone answers. She was losing an estimated 50% of calls during August, and property managers were dropping her from their preferred lists because she couldn't guarantee response times.",
        result: "Katie transformed Eleanor's Festival season. In August, she captured 31 emergency enquiries she would have missed. Fourteen were from property managers — the most valuable repeat customers. One New Town property management company, impressed that Katie answered at 11:30pm on a Saturday, added Eleanor to their primary contractor list for 23 properties. A standout was a £2,800 bathroom renovation in a Festival let on Royal Circus — the call came in at 3pm while Eleanor was fixing a burst pipe in Stockbridge. Katie took full details and the property manager booked her for the following week.",
        revenue: "£14,200 in August alone"
      },
      {
        name: "Callum Fraser",
        trade: "Builder",
        area: "Leith",
        story: "Callum runs a building firm specialising in Victorian tenement renovations across Edinburgh, from Leith to Marchmont. His projects are complex — stripping back 150 years of modifications, restoring original features, and modernising services while maintaining period character. Each project lasts 6-12 weeks, during which his phone is essentially unreachable while he's on site. The problem was his most valuable enquiries came from homeowners in similar properties who needed full renovations — jobs worth £25,000-£60,000. These customers typically research extensively, visit completed projects, and then call 3-4 builders. Callum was losing an estimated 40% of these high-value enquiries because he was physically demolishing a kitchen when they called.",
        result: "In his first month with Katie, Callum captured 12 major renovation enquiries. He converted 7 into site visits and 4 into signed contracts. The biggest was a £48,000 full-flat renovation in Bruntsfield — the call came at 10am while Callum was removing a load-bearing wall in Leith. Katie gathered the owner's vision, budget, timeline, and concerns about maintaining period features. Callum called back that evening fully prepared, visited the next day, and won the job against three other builders. The client specifically mentioned that Katie's professional handling gave him confidence in Callum's attention to detail.",
        revenue: "£18,400 in month one from captured calls"
      }
    ],
    localInsights: [
      "Edinburgh's Georgian New Town contains over 3,000 listed buildings — the largest concentration of Georgian architecture in the UK — creating massive demand for conservation trades",
      "The Festival season (August) increases trade call volumes by an estimated 40% due to short-term rental emergency maintenance demands",
      "Edinburgh's east coast climate brings the 'Haar' — sudden cold sea fog that causes rapid temperature drops and emergency heating call spikes",
      "The city has 49 Conservation Areas, the highest in Scotland, meaning most external work requires planning consideration",
      "Short-term rental property managers represent 25% of Edinburgh's trade market but make 55% of the calls — and they demand same-day response",
      "Properties on Edinburgh's south-facing slopes (Morningside, Bruntsfield) experience 30% more sun exposure damage than north-facing equivalents",
      "The Old Town's 'lands' and closes create unique access challenges — trades often need to carry materials up 5-10 storeys with no lift access"
    ]
  },
]
