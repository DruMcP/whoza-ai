...
const faqs = [
  {
    question: "What counts as a booked job?",
    answer: "A booked job is a job enquiry that the tradesperson has accepted via the Whoza WhatsApp channel (e.g. replying ACCEPT to the WhatsApp job card). Job cards sent but not accepted do not count toward plan job allowances and are not billed as extra jobs.",
    category: "Pricing",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes — the 7-day free trial is available on the Starter plan only. Your trial includes 100 minutes of call handling and up to 10 booked enquiries at no charge. No credit card required to start. If Whoza works for your business, you can upgrade to any plan. If not, you can cancel anytime during the trial with no charge.",
    category: "General",
  },
  {
