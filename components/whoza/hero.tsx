        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-[1.1] tracking-tight text-balance">
              ...
              <span className="text-[var(--rex-green)]">Booked Enquiries</span>
            ...
            <p className="mt-4 text-lg sm:text-xl text-white/70 leading-relaxed max-w-xl mx-auto lg:mx-0 text-pretty">
              Try Whoza risk-free — we answer your calls, qualify enquiries, and send them directly to your phone.
              <span className="block mt-2 text-white font-semibold">No apps. No logins. Just enquiries sent to your phone.</span>
              <span className="block mt-2 text-white font-semibold">Setup takes 30 minutes. First enquiries typically within days.</span>
            </p>
            ...
            >
              <span className="w-2 h-2 rounded-full bg-[var(--rex-green)] animate-pulse" />
              <span className="text-sm text-white/80">Call answered in 3 seconds • Enquiry booked: {config.currencySymbol}140 boiler repair • Confirmed instantly</span>
