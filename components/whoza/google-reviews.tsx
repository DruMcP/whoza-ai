        ...
        >
          ...
          <div className="inline-flex items-center gap-3 px-5 py-3 bg-white rounded-2xl shadow-sm border border-[var(--border)] mb-8">
            ...
            <div className="text-left">
              <p className="text-sm text-[var(--slate-500)]">Feedback from verified users · <a href="https://maps.app.goo.gl/dNHpTGPy1Kxeh7PV8" target="_blank" rel="noopener noreferrer" className="underline hover:text-[var(--navy-900)]">View on Google</a></p>
            </div>
          </div>
