        ...
        >
          ...
          <div className="inline-flex items-center gap-3 px-5 py-3 bg-white rounded-2xl shadow-sm border border-[var(--border)] mb-8">
            ...
            <div className="text-left">
              <p className="text-sm text-[var(--slate-500)]">Trusted by tradespeople across the UK · <a href="https://maps.app.goo.gl/dNHpTGPy1Kxeh7PV8" target="_blank" rel="noopener noreferrer" className="underline hover:text-[var(--navy-900)]">View on Google</a></p>
            </div>
          </div>

          {/* Mini Reviews */}
          <div className="mt-2 grid grid-cols-1 md:grid-cols-3 gap-4 reveal-stagger">
